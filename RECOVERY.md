...
* **2025-12-01 10:10**: Backup criado antes da análise técnica para V2.0. (Verificar pasta `backups/`)
* **2025-12-01 09:26**: Backup automático pré-análise de botões.
* **2025-11-24 10:35**: Backup manual criado antes da refatoração de `database.py`. Arquivo: `database.py.bak_20251124_103515`
* **2025-11-24 10:34**: Backup manual criado antes da refatoração de `database.py`. Arquivo: `database.py.bak_20251124_103415`
